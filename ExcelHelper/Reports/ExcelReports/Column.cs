...
namespace ExcelHelper.Reports.ExcelReports
{
    public class Column //TODO: Change this name to Cell
    {
        ...
        public DataColumn Data { get; set; } //TODO: What is usages of this property when we have Value property?
        public string Name { get; set; } //TODO: What is Name property for a Cell in Excel?
        public Type Type { get; set; } //TODO: What is this property for when we have Category property?
        ...
        public bool Visible { get; set; } //TODO: Move this to "FarshadColumnWidth" class
